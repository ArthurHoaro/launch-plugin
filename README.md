...
Launch Plugin is a plugin designed to enhance and customize [Launch Theme](https://github.com/ArthurHoaro/shaarli-launch) for [Shaarli](https://github.com/shaarli/Shaarli).
...
You can edit existing item, and add new one.
